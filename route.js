    ...
    const response = await fetch('https://api.fashn.ai/v1/run', {
      ...
      body: JSON.stringify({
        ...
        inputs: {
          ...
          prompt: 'Keep the exact original colors, patterns, textures and design of the garment. Preserve every detail of the fabric including plaid patterns, stripes, floral prints, and material texture. The garment must look identical to the product image in terms of color and design. Highly realistic and photographic result.',
        }
      }),
    })
