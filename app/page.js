      ...
      {phase === 'build' && (
        <div style={s.buildWrap}>
          ...
          <div style={{ flex: 1, minWidth: 0, padding: isMobile ? '1rem' : '1.5rem', paddingBottom: isMobile ? '80px' : undefined }}>
            ...
            {/* Spinner mobile pendant génération — visible dès la 1ère */}
            {isMobile && generating && (
              <div style={{ background: '#fff', border: '1px solid #e8e4df', borderRadius: '4px', padding: '1.5rem', marginBottom: '1.5rem', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '0.58rem', color: '#C9A96E', fontFamily: 'sans-serif', marginTop: '0.3rem' }}>{Math.round(progress)}% · L'IA Surmesur travaille pour vous</div>
              </div>
            )}
                ...
                <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: '#fff', zIndex: 99, borderRadius: '16px 16px 0 0', maxHeight: '88vh', display: 'flex', flexDirection: 'column', boxShadow: '0 -4px 24px rgba(0,0,0,0.15)' }}>
                  ...
                  <div style={{ padding: '1rem 1.25rem', borderTop: '1px solid #e8e4df', flexShrink: 0, background: '#fff' }}>
                    ...
                    <a href="https://www.surmesur.com" target="_blank" rel="noopener noreferrer"
                      style={{ display: 'block', width: '100%', padding: '0.95rem', background: '#000', color: '#fff', cursor: 'pointer', fontSize: '0.72rem', letterSpacing: '0.15em', fontFamily: 'sans-serif', textAlign: 'center', textDecoration: 'none', marginBottom: '0.5rem', boxSizing: 'border-box' }}>
                      PRENDRE MON RENDEZ-VOUS<br />
                      <span style={{ fontSize: '0.58rem', opacity: 0.65 }}>BOOK MY FREE APPOINTMENT</span>
                    </a>
                    {sidebarItems.length > 0 && (
                      <button
                        style={{ width: '100%', padding: '0.85rem', background: 'transparent', color: '#1a1a1a', border: '1px solid #1a1a1a', cursor: 'pointer', fontSize: '0.68rem', letterSpacing: '0.12em', fontFamily: 'sans-serif', textAlign: 'center', lineHeight: 1.7, boxSizing: 'border-box' }}
                        onClick={() => {
