...
export default function SurmesurTryOn() {
  ...
  const s = {
    ...
    pagePhoto: { minHeight: '100vh', backgroundColor: '#fafaf8', backgroundImage: `linear-gradient(rgba(250,250,248,0.46), rgba(250,250,248,0.56)), url(${BASE_URL}/accueil.jpg)`, backgroundSize: 'cover, contain', backgroundPosition: 'center, center', backgroundRepeat: 'no-repeat, no-repeat', backgroundAttachment: 'fixed', fontFamily: "'Cormorant Garamond', Georgia, serif", color: '#1a1a1a' },
